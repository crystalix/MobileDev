...
public class mcMapDataDBMgr extends SQLiteOpenHelper {
    ...
    private static final String DB_NAME = "catLocations.s3db";
    private static final String TBL_CATLOCATIONS = "catLocations";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_CATLOCATION_TABLE = "CREATE TABLE IF NOT EXISTS " +
                TBL_CATLOCATIONS + "("
                + COL_NAME + " TEXT," + COL_LATITUDE + " FLOAT" + COL_LONGITUDE + " FLOAT" +")";
        db.execSQL(CREATE_CATLOCATION_TABLE);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        {
            db.execSQL("DROP TABLE IF EXISTS " + TBL_CATLOCATIONS);
            onCreate(db);
        }
    }
...
>>>>>>> b1e04e1fba75fc424a5c53657c9ab24683151892
    ...
    public void addaCatEntry(mcMapData aCat) {

        ContentValues values = new ContentValues();
        values.put(COL_NAME, aCat.getName());
        values.put(COL_LATITUDE, aCat.getLatitude());
        values.put(COL_LONGITUDE, aCat.getLongitude());

        SQLiteDatabase db = this.getWritableDatabase();

        db.insert(TBL_CATLOCATIONS, null, values);
        db.close();
    }

    public mcMapData getCatEntry(String aCatEntry) {
        String query = "Select * FROM " + TBL_CATLOCATIONS + " WHERE " + COL_NAME + " =  \"" + aCatEntry + "\"";
        ...
        if (cursor.moveToFirst()) {
            cursor.moveToFirst();
            MapDataEntry.setName(cursor.getString(0));
    ...
    public boolean removeaCatEntry(String aCatEntry) {
    ...
    {
        String query = "Select * FROM " + TBL_CATLOCATIONS;
