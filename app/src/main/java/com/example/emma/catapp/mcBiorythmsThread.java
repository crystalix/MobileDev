...
//This class handles what will be drawn to the canvas
public class mcBiorythmsThread extends Thread
{
    ...
    private mcBiorythmSurfaceView bioSF;

    public mcBiorythmsThread(SurfaceHolder surfaceHolder, mcBiorythmSurfaceView bioSurfV) {
    ...
    //sets the colours and where to draw the lines
